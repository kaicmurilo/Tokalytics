(function (global) {
  ...
  var M = {
    en: {
      ...
      resourcesDiskHint: 'Disk usage sums known data folders per tool (e.g. ~/.claude, ~/.cursor, ~/.gemini, plus Cursor app data on macOS/Windows). Figures refresh about every 45 seconds.',
      ...
      liveToolMeta: 'Σ CPU {cpu}% · RAM {ram} · Disk {disk} · {n} proc.',
      liveDiskFolders: 'Folders',
      ...
      errNoData: 'Incomplete server response. Reload or check Tokalytics.',
      ...
      providerUseClaude: 'Use Claude Code (~/.claude), Cursor (~/.cursor) or Codex (~/.codex) on this machine for local session data.',
      ...
      cursorModelReqTitle: 'Account · requests this month by model',
      cursorModelReqHint: 'Local agent transcripts usually omit the model; when Cursor is linked, monthly request counts per model appear here.',
      cursorModelReqHdrModel: 'Model',
      cursorModelReqHdrRequests: 'Requests',
      ...
      statsTabModels: 'Models',
      statsFilterAll: 'All',
      statsFilter30d: '30d',
      statsFilter7d: '7d',
      statsFilterToday: 'Today',
      statsFilterYesterday: 'Yesterday',
      statActiveDays: 'Active days',
      statCurrentStreak: 'Current streak',
      statLongestStreak: 'Longest streak',
      statPeakHour: 'Peak hour',
      statFavoriteModel: 'Favorite model',
      statStreakDays: '{n}d',
      statNoData: '—',
      heatmapNoActivity: 'No activity',
      heatmapTooltip: '{date} · {n} tokens',
      modelCardSessions: '{n} sessions',
      modelCardMessages: '{n} messages',
      modelCardOfTotal: '{n}% of total',
      modelCardTokens: '{n} tokens',
    },
    'pt-BR': {
      ...
      resourcesDiskHint: 'O uso em disco soma pastas conhecidas de cada ferramenta (ex.: ~/.claude, ~/.cursor, ~/.gemini e dados do app Cursor no macOS/Windows). Atualização a cada ~45 s.',
      ...
      liveToolMeta: 'Σ CPU {cpu}% · RAM {ram} · Disco {disk} · {n} proc.',
      liveDiskFolders: 'Pastas',
      ...
      errNoData: 'Resposta do servidor incompleta. Recarregue ou verifique o Tokalytics.',
      ...
      providerUseClaude: 'Use o Claude Code (~/.claude), o Cursor (~/.cursor) ou o Codex (~/.codex) nesta máquina para gerar dados locais.',
      ...
      cursorModelReqTitle: 'Conta · pedidos no mês por modelo',
      cursorModelReqHint: 'Os transcripts JSONL locais costumam omitir o modelo; com a conta Cursor ligada, aparecem aqui os pedidos mensais por modelo.',
      cursorModelReqHdrModel: 'Modelo',
      cursorModelReqHdrRequests: 'Pedidos',
      ...
      statsTabOverview: 'Overview',
      statsTabModels: 'Modelos',
      statsFilterAll: 'Tudo',
      statsFilter30d: '30d',
      statsFilter7d: '7d',
      statsFilterToday: 'Hoje',
      statsFilterYesterday: 'Ontem',
      statActiveDays: 'Dias ativos',
      statCurrentStreak: 'Sequência atual',
      statLongestStreak: 'Maior sequência',
      statPeakHour: 'Horário de pico',
      statFavoriteModel: 'Modelo favorito',
      statStreakDays: '{n}d',
      statNoData: '—',
      heatmapNoActivity: 'Sem atividade',
      heatmapTooltip: '{date} · {n} tokens',
      modelCardSessions: '{n} sessões',
      modelCardMessages: '{n} mensagens',
      modelCardOfTotal: '{n}% do total',
      modelCardTokens: '{n} tokens',
    },
  };
